...
- [ ] **[3.4] Coupon Dialog** — Manual coupon validation overlay handler in cart summary.
- [ ] **[3.5] Checkout Gateways** — Cash change math, UPI QR display, reference tracking, and email dispatch.
- [ ] **[3.6] Order Ledger** — Reloads `Draft` orders for editing; locks `Paid` entries as view-only.
- [ ] **[3.7] Table View State** — Dynamic visual updates mapping table order states across floors.
- [ ] **[3.8] Customer CRM** — Guest registration and direct linking to digital checkout receipts.
